...
export type Order = { id: string; status: string; payment_status: string; fulfillment_type: string; subtotal: Money; delivery_fee: Money; tax_amount: Money; discount_amount: Money; total_amount: Money; placed_at: string; delivery_address: string | null; restaurant?: { id: string; name: string }; items: { id: string; menu_item_id: string; item_name_snapshot: string; quantity: number; unit_price: Money; total_price: Money }[] };
